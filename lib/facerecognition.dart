...
// import './app/utils/facerecognition/detector_painters.dart';
// import './app/utils/facerecognition/utils_facerecognition.dart';
// import 'package:image/image.dart' as imglib;
// import 'package:quiver/collection.dart';
// import 'package:flutter/services.dart';
// import './app/modules/inputabsen/controllers/inputabsen_controller.dart';

// List<CameraDescription>? cameras;
// final inputAbsen = Get.put(InputabsenController());
// int isInput = 0;

// class RegisterFace extends StatefulWidget {
//   final String? flaging;

//   RegisterFace({Key? key, this.flaging}) : super(key: key);
...
//           IconButton(
//               onPressed: () {
//                 widget.flaging ?? _showFaceDialog();
//               },
//               icon: widget.flaging != null
//                   ? Text("")
...
//           _sessionTimer = new Timer(const Duration(seconds: 1), handleTimeOut);
//         }
//         isInput = 1;
//       }
//     }
...
//   void handleTimeOut() {
//     // Get.offNamed(Routes.ABSENSI);
//     Get.back();
//     inputAbsen.inputAbsen(widget.flaging);
//   }
...
//   Future<void> _showFaceDialog() async {
...
//                 Text('Kamu yakin ingin hapus Wajah?'),
//               ],
//             ),
//           ),
//           actions: <Widget>[
